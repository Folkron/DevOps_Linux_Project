...
>
> ![Вывод файла /etc/issue](screen/screen_1_01.png)
>
...
> Установка **ipcalc**:
>
> ![Установка ipcalc](screen/screen_1_02.png)
>
...
>
> ![Вывод команды ipcalc 192.167.38.54/13](screen/screen_1_03.png)
>
...
>
> ![Вывод команды ipcalc 255.255.255.0](screen/screen_1_04.png)
>
...
>
> ![Вывод команды ipcalc 0.0.0.0/15](screen/screen_1_05.png)
>
...
>
> ![Вывод команды ipcalc 0.0.0.0/28](screen/Fscreen_1_06.png)
>
...
>
> ![Вывод команды ipcalc 12.167.38.4/8](screen/screen_1_07.png)
>
...
>
> ![Вывод команды ipcalc 0.0.0.0/16](screen/screen_1_08.png)
>
...
>
> ![Вывод команды ipcalc 0.0.0.0/255.255.254.0](screen/screen_1_09.png)
>
...
>
> ![Вывод команды ipcalc 0.0.0.0/4](screen/screen_1_10.png)
>
...
>
> ![Вывод команды ipcalc 127.0.0.0/8](screen/screen_1_11.png)
>
...
>
> ![Вывод команды ipcalc 10.0.0.0/8](screen/screen_1_12.png)
>
...
>
> ![Вывод команды ipcalc 172.16.0.0/12](screen/Fscreen_1_13.png)
>
...
>
> ![Вывод команды ipcalc 192.168.0.0/16](screen/screen_1_14.png)
>
...
>
> ![Вывод команды ipcalc 10.10.0.0/18](screen/screen_1_15.png)
>
...
> Вывод файла `/etc/issue`:
>
> ![Вывод файла /etc/issue](screen/screen_2_01.png)
>
...
>
> ![Вывод команды ip a ws1](screen/screen_2_02.png)
>
...
>
> ![Вывод команды ip a ws2](screen/screen_2_03.png)
>
...
>
> ![Добавление нового интерфейса в VB ws1(1)](screen/screen_2_04.png)
> ![Добавление нового интерфейса VB ws1(2)](screen/screen_2_05.png)
> ![Добавление нового интерфейса VB ws1(3)](screen/screen_2_06.png)
>
...
>
> ![Добавление нового интерфейса в VB ws2](screen/screen_2_07.png)
>
...
> Вывод команды `ip a` (ws1):
>
> ![Вывод команды ip a ws1](screen/screen_2_08.png)
>
...
> Вывод команды `ip a` (ws2):
>
> ![Вывод команды ip a ws2](screen/screen_2_09.png)
>
...
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml (ws1)](screen/screen_2_10.png)
>
...
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml (ws2)](screen/screen_2_11.png)
>
...
>
> ![Применение настроек сети (ws1)](screen/screen_2_12.png)
>

> Применение настроек сети (ws2):
>
> ![Применение настроек сети (ws2)](screen/screen_2_13.png)
>
...
>
> ![Добавляем статический маршрут от ws1 до ws2](screen/screen_2_14.png)
>
...
>
> ![Добавляем статический маршрут от ws2 до ws1](screen/screen_2_15.png)
>
...
>
> ![Успешно пропингованный ip 172.24.116.8](screen/screen_2_16.png)
>
...
>
> ![Успешно пропингованный ip 192.168.100.10](screen/screen_2_17.png)
>
...
> Измененный файл конфигурации `/etc/netplan/00-installer-config.yaml` (ws1):
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml (ws1)](screen/screen_2_18.png)
>
...
> Измененный файл конфигурации `/etc/netplan/00-installer-config.yaml` (ws2):
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml (ws2)](screen/screen_2_19.png)
>
...
> Успешно пропингованный ip 172.24.116.8:
>
> ![Успешно пропингованный ip 172.24.116.8](screen/screen_2_20.png)
>
...
> Успешно пропингованный ip 192.168.100.10:
>
> ![Успешно пропингованный ip 192.168.100.10](screen/screen_2_21.png)
>
...
>
> ![Установка утилиты ipef3](screen/screen_3_01.png)
>
...
>
> ![Вывод команды iperf3 -s ws1](screen/screen_3_02.png)
>
...
>
> ![Вывод команды iperf3 -c 192.168.100.10 ws2](screen/screen_3_03.png)
>
...
>
> ![Настроенный на удаление всех правил в таблице «filter» файл /etc/firewall.sh ws1 ws2](screen/screen_4_01.png)
>
...
>
> ![Настроенный на удаление всех правил в таблице «filter» файл /etc/firewall.sh ws1](screen/screen_4_02.png)
>
...
>
> ![Настроенный на удаление всех правил в таблице «filter» файл /etc/firewall.sh ws2](screen/screen_4_03.png)
>
...
>
> ![Применение команд chmod +x /etc/firewall.sh и /etc/firewall.sh ws1](screen/screen_4_04.png)
>

> Применение команд `sudo` `chmod +x /etc/firewall.sh` и `/etc/firewall.sh` (ws2):
>
> ![Применение команд chmod +x /etc/firewall.sh и /etc/firewall.sh ws2](screen/screen_4_05.png)
>
...
>
> ![Успешно пропингованный ip 172.24.116.8](screen/screen_4_06.png)
> 
...
>
> ![Пинг без ответа ip 192.168.100.10](screen/screen_4_07.png)
> 
...
>
> ![Установка утилиты nmap](screen/screen_4_08.png)
>
...
>
> ![Вывод nmap](screen/screen_4_09.png)
>
...
>
> ![Сохранение дампа образа виртуальной машины в VB ws1(1)](screen/screen_4_10.png)
> ![Сохранение дампа образа виртуальной машины в VB ws1:(2)](screen/screen_4_11.png)
> ![Сохранение дампа образа виртуальной машины в VB ws1(3)](screen/screen_4_12.png)
> ![Сохранение дампа образа виртуальной машины в VB ws1(4)](screen/screen_4_13.png)
>
...
>
> ![Сохранение дампа образа виртуальной машины в VB ws2](screen/screen_4_14.png)
>
...
>
> ![Т/З по маршрутизации](screen/screen_5_01.png)
>
...
>
> ![Добавление нового интерфейса в VB ws11](screen/screen_5_02.png)
>
...
>
> ![Добавление нового интерфейса в VB ws21](screen/screen_5_03.png)
>
...
>
> ![Добавление нового интерфейса в VB ws22](screen/screen_5_04.png)
>
> Имя внутренней сети указал `intnet3`, которая будет соответствовать 10.20.0.0/26
>
...
>
> ![Добавление нового интерфейса в VB r1(1)](screen/screen_5_05.png)
> 
> Имя внутренней сети указал `intnet1`, которая будет соответствовать 10.10.0.0/18
>
> ![Добавление нового интерфейса VB r1(2)](screen/screen_5_06.png)
>
...
>
> ![Добавление нового интерфейса в VB r2(1)](screen/screen_5_07.png)
> 
> Имя внутренней сети указал `intnet2`, которая будет соответствовать 10.100.0.0/16
>
> ![Добавление нового интерфейса VB r2(2)](screen/screen_5_08.png)
>
> Имя внутренней сети указал `intnet3`, которая будет соответствовать 10.20.0.0/26
>
...
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml ws11](screen/screen_5_09.png)
>
...
>
> ![Применение настроек конфигураций **netplan** на ws11](screen/screen_5_10.png)
>
...
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml ws21](screen/screen_5_11.png)
>
...
>
> ![Применение настроек конфигураций **netplan** на ws21](screen/screen_5_12.png)
>
...
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml ws22](screen/screen_5_13.png)
>
...
>
> ![Применение настроек конфигураций **netplan** на ws22](screen/screen_5_14.png)
>
...
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml r1](screen/screen_5_15.png)
>
...
>
> ![Применение настроек конфигураций **netplan** на r1](screen/screen_5_16.png)
>
...
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml r2](screen/screen_5_17.png)
>
...
>
> ![Применение настроек конфигураций **netplan** на r2](screen/screen_5_18.png)
>
...
>
> ![Вывод команды ip -4 a ws11](screen/screen_5_19.png)
>
...
>
> ![Вывод команды ip -4 a ws21](screen/screen_5_20.png)
>
...
>
> ![Вывод команды ip -4 a ws22](screen/screen_5_21.png)
>
...
>
> ![Вывод команды ip -4 a r1](screen/screen_5_22.png)
>
...
>
> ![Вывод команды ip -4 a r2](screen/screen_5_23.png)
>
...
>
> ![Успешно пропингованный ip 10.20.0.20](screen/screen_5_24.png)
>
...
>
> ![Успешно пропингованный ip 10.20.0.20](screen/screen_5_25.png)
>
...
>
> ![Вывод команды sudo sysctl -w net.ipv4.ip_forward=1 r1](screen/screen_5_26.png)
>

> Вывод команды `sudo sysctl -w net.ipv4.ip_forward=1` (r2):
>
> ![Вывод команды sudo sysctl -w net.ipv4.ip_forward=1 r2](screen/screen_5_27.png)
>
...
>
> ![Измененный файл /etc/sysctl.conf r1](screen/screen_5_28.png)
>

> Измененный файл `/etc/sysctl.conf` (r2):
>
> ![Измененный файл /etc/sysctl.conf r2](screen/screen_5_29.png)
>
...
>
> ![Измененный файл etc/netplan/00-installer-config.yaml ws11](screen/screen_5_30.png)
>
...
>
> ![Измененный файл etc/netplan/00-installer-config.yaml ws21](screen/screen_5_31.png)
>
...
>
> ![Измененный файл etc/netplan/00-installer-config.yaml ws22](screen/screen_5_32.png)
>
...
>
> ![Вывод команды ip r ws11](screen/screen_5_33.png)
> 
...
>
> ![Вывод команды ip r ws21](screen/screen_5_34.png)
> 
...
>
> ![Вывод команды ip r ws22](screen/screen_5_35.png)
> 
> Маршрут интерфейса enp0s8 по-умолчанию установился по-заданному ip 10.20.0.1
>
...
>
> ![Вывод команды ping 10.100.0.12 ws21](screen/screen_5_36.png)
>
...
>
> ![Вывод команды sudo tcpdump -tn -i enp0s8 r2](screen/screen_5_37.png)
> 
...
> Измененный файл конфигурации `/etc/netplan/00-installer-config.yaml` (r1):
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml r1](screen/screen_5_38.png)
>
...
> Измененный файл конфигурации `/etc/netplan/00-installer-config.yaml` (r2):
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml r2](screen/screen_5_39.png)
>
...
>
> ![Вывод команды ip r r1](screen/screen_5_40.png)
> 
...
>
> ![Вывод команды ip r r2](screen/screen_5_41.png)
> 
...
>
> ![Вывод команд ip r list 10.10.0.0/18 и ip r list 0.0.0.0/0 ws11](screen/screen_5_42.png)
> 
...
>
> ![Установка traceroute](screen/screen_5_43.png)
>
...
>
> ![Вывод команды sudo tcpdump -tnv -i enp0s8 r1](screen/screen_5_44.png)
>
...
>
> ![Вывод команды traceroute 10.20.0.10 ws11](screen/screen_5_45.png)
>
...
>
> ![Вывод команды sudo tcpdump -tnv -i enp0s8 r1](screen/screen_5_46.png)
>
...
>
> ![Вывод команды ping -c 1 10.30.0.111 ws11](screen/screen_5_47.png)
>
...
> Вывод команды `sudo tcpdump -tnv -i enp0s8` (r1):
>
> ![Вывод команды sudo tcpdump -tnv -i enp0s8 r1](screen/screen_5_48.png)
>
...
>
> ![Сохранение дампа образа виртуальной машины в VB ws11](screen/screen_5_49.png)
>

> Сохранение дампа образа виртуальной машины в VB ws21:
>
> ![Сохранение дампа образа виртуальной машины в VB ws21](screen/screen_5_50.png)
>

> Сохранение дампа образа виртуальной машины в VB ws22:
>
> ![Сохранение дампа образа виртуальной машины в VB ws22](screen/screen_5_51.png)
>

> Сохранение дампа образа виртуальной машины в VB r1:
>
> ![Сохранение дампа образа виртуальной машины в VB r1](screen/screen_5_52.png)
>

> Сохранение дампа образа виртуальной машины в VB r2:
>
> ![Сохранение дампа образа виртуальной машины в VB r2](screen/screen_5_53.png)
>
...
>
> ![ip адрес интерфейса enp0s8 ws22](screen/screen_6_01.png)
>
...
>
> ![Установка isc-dhcp-server r2](screen/screen_6_02.png)
>
...
>
> ![Файл /etc/default/isc-dhcp-server r2](screen/screen_6_03.png)
>
...
>
> ![Вывод команды ip addr r2](screen/screen_6_04.png)
>

> Отредактированный файл `/etc/default/isc-dhcp-server` (r2):
>
> ![Отредактированный файл /etc/default/isc-dhcp-server r2](screen/screen_6_05.png)
>
...
>
> ![Отредактированный файл /etc/dhcp/dhcpd.conf r2](screen/screen_6_06.png)
>
...
> Отредактированный файл `/etc/dhcp/dhcpd.conf` (r2):
>
> ![Отредактированный файл /etc/dhcp/dhcpd.conf r2](screen/screen_6_07.png)
>
...
>
> ![Отредактированный файл /etc/resolv.conf r2](screen/screen_6_08.png)
>
...
>
> ![Успешно запущенная система DHCP-сервераf r2](screen/screen_6_09.png)
>
...
>
> ![Отредактированный файл /etc/netplan/00-installer-config.yaml ws22](screen/screen_6_10.png)
> 
...
> Новый ip адрес (ws22):
>
> ![Новый ip адрес ws22](screen/screen_6_11.png)
>
...
>
> ![Вывод команды ip a ws22](screen/screen_6_12.png)
>
...
>
> ![Успешно пропингованный ip 10.20.0.36](screen/screen_6_13.png)
>
...
>
> ![ip адрес интерфейса enp0s8 ws11](screen/screen_6_14.png)
>
...
>
> ![Отредактированный файл /etc/netplan/00-installer-config.yaml ws11](screen/screen_6_15.png)
>
...
>
> ![Указание нового MAC-адреса в VB ws11](screen/screen_6_16.png)
>
...
>
> ![Отредактированный файл /etc/resolv.conf r1](screen/screen_6_17.png)
>
...
>
> ![Отредактированный файл /etc/default/isc-dhcp-server r2](screen/screen_6_18.png)
>
...
>
> ![Отредактированный файл /etc/dhcp/dhcpd.conf r2](screen/screen_6_19.png)
>
> ![Отредактированный файл /etc/dhcp/dhcpd.conf r2](screen/screen_6_20.png)
>
...
>
> ![Успешно запущенная система DHCP-сервера r1](screen/screen_6_21.png)
>
...
>
> ![Новый ip полученный по MAC-адресу ws11](screen/screen_6_22.png)
>
...
> Успешно пропингованный ip 10.20.0.36:
>
> ![Успешно пропингованный ip 10.20.0.36](screen/screen_6_23.png)
>
...
>
> ![ip адрес интерфейса enp0s8 ws21](screen/screen_6_24.png)
>
...
> Новый ip адрес (ws21):
>
> ![Новый ip адрес ws21](screen/screen_6_25.png)
>
...
> Сохранение дампа образа виртуальной машины в VB ws11:
>
> ![Сохранение дампа образа виртуальной машины в VB ws11](screen/screen_6_26.png)
>

> Сохранение дампа образа виртуальной машины в VB ws21:
>
> ![Сохранение дампа образа виртуальной машины в VB ws21](screen/screen_6_27.png)
>

> Сохранение дампа образа виртуальной машины в VB ws22:
>
> ![Сохранение дампа образа виртуальной машины в VB ws22](screen/screen_6_28.png)
>

> Сохранение дампа образа виртуальной машины в VB r1:
>
> ![Сохранение дампа образа виртуальной машины в VB r1](screen/screen_6_29.png)
>

> Сохранение дампа образа виртуальной машины в VB r2:
>
> ![Сохранение дампа образа виртуальной машины в VB r2](screen/screen_6_30.png)
>
...
>
> ![Установка утилиты apache2](screen/screen_7_01.png)
>
...
>
> ![Установка утилиты apache2](screen/screen_7_02.png)
>

> Файл `/etc/apache2/ports.conf` после изменений (ws22):
>
> ![Установка утилиты apache2](screen/screen_7_03.png)
>

> Файл `/etc/apache2/ports.conf` после изменений (r1):
>
> ![Установка утилиты apache2](screen/screen_7_04.png)
>
...
>
> ![Успешный запуск сервера Apache ws22](screen/screen_7_05.png)
>
...
>
> ![Успешный запуск сервера Apache r1](screen/screen_7_06.png)
>
...
>
> ![Созданый срипт-файл /etc/firewall.sh на r2](screen/screen_7_07.png)
>
...
>
> ![Вывод команд chmod +x /etc/firewall.sh и /etc/firewall.sh r2](screen/screen_7_08.png)
>
...
>
> ![Вывод команды sudo iptables -L --line-number r2](screen/screen_7_09.png)
>
...
>
> ![Пинг ws22 без ответа ip 10.20.0.20 r1](screen/screen_7_10.png)
>
...
>
> ![Измененный файл /etc/firewall.sh r2](screen/screen_7_11.png)
>
...
> Применение команд `sudo` `chmod +x /etc/firewall.sh` и `/etc/firewall.sh` (r2):
>
> ![Применение команд sudo chmod +x /etc/firewall.sh и /etc/firewall.sh r2](screen/screen_7_12.png)
>
...
> Вывод команды `sudo` `iptables -L --line-number` (r2):
>
> ![Вывод команды sudo iptables -L --line-number r2](screen/screen_7_13.png)
>
...
>
> ![Успешно пропингованный ip 10.20.0.20 r1](screen/screen_7_14.png)
>
...
> Измененный файл `/etc/firewall.sh` (r2):
>
> ![Измененный файл /etc/firewall.sh (r2)](screen/screen_7_15.png)
>
...
>
> ![Отключение сетевого интерфейса enp0s3 в VBx r2](screen/screen_7_16.png)
>
...
>
> ![Измененный файл /etc/netplan/00-installer-config.yam r2](screen/screen_7_17.png)
>
...
>
> ![Список активных сетевых интерфейсов r2](screen/screen_7_18.png)
>
...
> Применение команд `sudo` `chmod +x /etc/firewall.sh` и `/etc/firewall.sh` (r2):
>
> ![Применение команд sudo chmod +x /etc/firewall.sh и /etc/firewall.sh r2](screen/screen_7_19.png)
>
...
> Вывод команды `sudo` `iptables -L --line-number` (r2):
>
> ![Вывод команды sudo iptables -L --line-number r2](screen/screen_7_20.png)
>
...
>
> ![Вывод команды telnet 10.10.0.1 80 ws22](screen/screen_7_21.png)
>
...
>
> ![Вывод команды telnet 10.20.0.1 8080 r1](screen/screen_7_22.png)
>
...
> Сохранение дампа образа виртуальной машины в VB ws11:
>
> ![Сохранение дампа образа виртуальной машины в VB ws11](screen/screen_7_23.png)
>

> Сохранение дампа образа виртуальной машины в VB ws21:
>
> ![Сохранение дампа образа виртуальной машины в VB ws21](screen/screen_7_24.png)
>

> Сохранение дампа образа виртуальной машины в VB ws22:
>
> ![Сохранение дампа образа виртуальной машины в VB ws22](screen/screen_7_25.png)
>

> Сохранение дампа образа виртуальной машины в VB r1:
>
> ![Сохранение дампа образа виртуальной машины в VB r1](screen/screen_7_26.png)
>

> Сохранение дампа образа виртуальной машины в VB r2:
>
> ![Сохранение дампа образа виртуальной машины в VB r2](screen/screen_7_27.png)
>
...
>
> ![Действующие правила iptables r2](screen/screen_8_01.png)
>
...
>
> ![Измененный файл /etc/apache2/ports.conf ws22](screen/screen_8_02.png)
>
...
>
> ![Успешный запуск apache2 ws22](screen/screen_8_03.png)
>
...
>
> ![Успешный запуск ssh ws22](screen/screen_8_04.png)
>
...
>
> ![Успешное подключение по ssh с ws21 к ws22](screen/screen_8_05.png)
>
...
>
> ![Вывод команды telnet 127.0.0.1 8080 ws21](screen/screen_8_06.png)
>
...
>
> ![Успешное подключение по ssh с ws11 к ws22](screen/screen_8_07.png)
>
...
>
> ![Вывод команды telnet 127.0.0.1 8080 ws11](screen/screen_8_08.png)
>
...
> Сохранение дампа образа виртуальной машины в VB ws11:
>
> ![Сохранение дампа образа виртуальной машины в VB ws11](screen/screen_8_09.png)
>

> Сохранение дампа образа виртуальной машины в VB ws21:
>
> ![Сохранение дампа образа виртуальной машины в VB ws21](screen/screen_8_10.png)
>

> Сохранение дампа образа виртуальной машины в VB ws22:
>
> ![Сохранение дампа образа виртуальной машины в VB ws22](screen/screen_8_11.png)
>

> Сохранение дампа образа виртуальной машины в VB r1:
>
> ![Сохранение дампа образа виртуальной машины в VB r1](screen/screen_8_12.png)
>

> Сохранение дампа образа виртуальной машины в VB r2:
>
> ![Сохранение дампа образа виртуальной машины в VB r2](screen/screen_8_13.png)
>
